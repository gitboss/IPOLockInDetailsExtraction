...
def get_master_data_by_best_match(
    ...
    """
    Last-resort fallback when primary (symbol) and secondary (url_slug) lookups both fail.
    Fetches all records for the exchange and matches by normalised company_name or ipo_name,
    handling spelling variants like "Biotec" vs "Biotech".
    """
    import re as _re
